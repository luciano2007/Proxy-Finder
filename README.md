...
bash
git clone https://github.com/<your-username>/Proxy-Finder.git
cd Proxy-Finder
...
Run the script:
When prompted, enter how many proxies you want (recommended: 1–15).
​

The script will scrape the configured sites and print or save the collected proxies (implementation‑dependent; update README once finalized in code).
​
